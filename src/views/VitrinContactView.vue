<template>
  <div class="w-full">
    ...
    >
      درصورتی که فیلد ها رو خالی بگذارید نمایش داده نمیشوند . این اطلاعات صرفا
      جهت نمایش در ویترین بوده و ارتباطی به حساب کاربری کارت ساز شما ندارد
    </div>
    <div class="w-full mt-6">
      ...
      />
      <label for="">آیدی اینستاگرام</label>
      <input
        type="text"
